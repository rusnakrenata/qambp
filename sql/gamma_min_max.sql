...
select nr_of_nodes, 
count(min_lambda_mult) as c_min_lambda_mult, min_lambda_mult,
count(max_lambda_mult) as c_max_lambda_mult, max_lambda_mult
from p4
group by nr_of_nodes, min_lambda_mult, max_lambda_mult
